...
+ (void)setAppName:(NSString * _Null_unspecified)value;
...
+ (void)setRingtoneSound:(NSString * _Null_unspecified)value;
...
+ (void)setCallIconTemplate:(NSData * _Null_unspecified)value;
...
- (void)launchCallWithBidId:(NSString * _Nonnull)bidId parameter:(Snapcall_External_Parameter * _Null_unspecified)parameter;
- (void)launchCallWithBidId:(NSString * _Nonnull)bidId sendClientMessage:(void (^ _Null_unspecified)(NSString * _Nonnull))sendClientMessage parameter:(Snapcall_External_Parameter * _Null_unspecified)parameter;
- (void)launchCallWithBidId:(NSString * _Nonnull)bidId applicationName:(NSString * _Nonnull)applicationName customClientIdentifier:(NSString * _Nonnull)customClientIdentifier parameter:(Snapcall_External_Parameter * _Null_unspecified)parameter;
- (void)launchCallWithBidId:(NSString * _Nonnull)bidId snapcallIdentifier:(NSString * _Nonnull)snapcallIdentifier parameter:(Snapcall_External_Parameter * _Null_unspecified)parameter;
- (void)restorCallUI;
...
- (void)receiveCallWithPushKitPayload:(PKPushPayload * _Null_unspecified)pushKitPayload parameter:(Snapcall_External_Parameter * _Null_unspecified)parameter;

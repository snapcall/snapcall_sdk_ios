# Snapcall IOS SDK
version 5.8.0 : swift package manager
...
github "snapcall/snapcall_sdk_ios" == 5.8.0

## cocoapod

pod 'Snapcall_Framework', :git => 'https://github.com/snapcall/snapcall_sdk_ios', :tag => '5.8.0'

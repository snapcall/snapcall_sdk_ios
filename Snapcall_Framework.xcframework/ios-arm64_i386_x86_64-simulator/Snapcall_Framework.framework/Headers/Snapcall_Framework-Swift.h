...
- (CallViewProperties * _Nonnull)setIconColorInactiveWithColor:(UIColor * _Nonnull)color SWIFT_WARN_UNUSED_RESULT;
- (UIColor * _Nonnull)getIconColorInactive SWIFT_WARN_UNUSED_RESULT;
...
- (CallViewProperties * _Nonnull)setIconBGColorInactive:(UIColor * _Nonnull)color SWIFT_WARN_UNUSED_RESULT;

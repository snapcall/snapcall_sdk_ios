...
SWIFT_CLASS("_TtC8snapcall10RatingView")
...
@interface RatingView (SWIFT_EXTENSION(snapcall))
...
SWIFT_PROTOCOL("_TtP8snapcall18RatingViewDelegate_")
@protocol RatingViewDelegate
...
SWIFT_CLASS("_TtC8snapcall15Snapcall_Button")
